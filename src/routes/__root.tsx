...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "FleetCRM — Truck buyer CRM" },
      { name: "description", content: "Research Swedish trucking fleets, dial leads with one click, and track deals end-to-end." },
      { property: "og:title", content: "FleetCRM — Truck buyer CRM" },
      { name: "twitter:title", content: "FleetCRM — Truck buyer CRM" },
      { property: "og:description", content: "Research Swedish trucking fleets, dial leads with one click, and track deals end-to-end." },
      { name: "twitter:description", content: "Research Swedish trucking fleets, dial leads with one click, and track deals end-to-end." },
